...
/*   Updated: 2023/08/29 23:53:50 by llevasse         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	separate_cmd(t_prompt *p, char *input, t_minishell *shell)
{
	int	pos;
	...
	input += pos;
	pos = p->lvl + 1;
	ft_add_prompt(&p, init_prompt(input, shell->garbage, p->shell, pos));
}
